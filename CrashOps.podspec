#
#  Be sure to run `pod spec lint crashopscrashops.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "CrashOps" => "developer@crashops.com" }
...
s.dependency 'KZCrash', '1.15.21' # Using remote cocoa pod
